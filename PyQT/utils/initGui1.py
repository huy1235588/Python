...
class GUI:
    ...
    def init_main_window(self):
        ...
        self.ui.ipv4_primary_line_edit.textChanged.connect(self.primary_changed)
        self.ui.ipv4_secondary_line_edit.textChanged.connect(self.secondary_changed)
    ...
    def init_fastest_window(self):
        ...
        self.fastest.ui.ping_table.horizontalHeader().setSectionResizeMode(QtWidgets.QHeaderView.ResizeMode.Stretch)
    ...
    def select_dns_combo_box_changed(self, index):
        ...
        self.ui.ipv4_primary_line_edit.setText(self.data.data['dns_list'][index]['primary'])
        self.ui.ipv4_secondary_line_edit.setText(self.data.data['dns_list'][index]['secondary'])
